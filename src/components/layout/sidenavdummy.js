...
import {
  DashboardOutlined, FundOutlined, TableOutlined, UserOutlined, LoginOutlined, UserAddOutlined,
  ...
  return (
    <>
      ...
      <Menu theme="light" mode="inline">
          ...
          <Menu.Item key="1">
            <NavLink to="/allInvestments" exact>
              <span
                className="icon"
                style={{
                  background: page === "allInvestments" ? color : "",
                }}
              >
                <BankOutlined />
              </span>
          ...
          <Menu.Item key="2">
            <NavLink to="/businessDashboard" exact>
              <span
                className="icon"
                style={{
                  background: page === "businessDashboard" ? color : "",
                }}
              >
                <AppstoreOutlined />
              </span>
          ...
          <Menu.Item key="3">
            <NavLink to="/businessInformation" exact>
              <span
                className="icon"
                style={{
                  background: page === "businessInformation" ? color : "",
                }}
              >
                <InfoCircleOutlined />
              </span>
        ...
        {role === "BUSINESS" && (
          <Menu.Item key="4">
            <NavLink to="/fundraising" exact>
              <span
                className="icon"
                style={{ background: page === "fundraising" ? color : "" }}
              >
                <FundOutlined />
              </span>
        ...
        {/* <Menu.Item key="7">
          <NavLink to="/businessProfile" exact>
            <span
              className="icon"
              style={{
                background: page === "businessProfile" ? color : "",
              }}
            >
               <ProfileOutlined   />
            </span>
          ...
          <Menu.Item key="5">
            <NavLink to="/businessInvestments" exact>
              <span
                className="icon"
                style={{
                  background: page === "businessInvestments" ? color : "",
                }}
              >
                <ShopOutlined />
              </span>
          ...
          <Menu.Item key="6">
            <NavLink to="/previousVentures" exact>
              <span
                className="icon"
                style={{
                  background: page === "previousVentures" ? color : "",
                }}
              >
                <HistoryOutlined />
              </span>
          ...
          <Menu.Item key="7">
            <NavLink to="/investorList" exact>
              <span
                className="icon"
                style={{
                  background: page === "investorList" ? color : "",
                }}
              >
                <TeamOutlined />
              </span>
          ...
          <Menu.Item key="8">
            <NavLink to="/investorDashboard" exact>
              <span
                className="icon"
                style={{
                  background: page === "investorDashboard" ? color : "",
                }}
              >
                <AreaChartOutlined />
              </span>
          ...
          <Menu.Item key="9">
            <NavLink to="/myInvestment" exact>
              <span
                className="icon"
                style={{
                  background: page === "myInvestment" ? color : "",
                }}
              >
                <DollarOutlined />
              </span>
          ...
          <Menu.Item key="10">
            <NavLink to="/investorFundraising" exact>
              <span
                className="icon"
                style={{
                  background: page === "investorFundraising" ? color : "",
                }}
              >
                <VerifiedOutlined />
              </span>
          ...
          <Menu.Item key="11">
            <NavLink to="/myPledgesList" exact>
              <span
                className="icon"
                style={{
                  background: page === "myPledgesList" ? color : "",
                }}
              >
                <SolutionOutlined />
              </span>
          ...
          <Menu.Item key="12">
            <NavLink to="/listedCompany" exact>
              <span
                className="icon"
                style={{
                  background: page === "listedCompany" ? color : "",
                }}
              >
                <UnorderedListOutlined />
              </span>
          ...
          <Menu.Item key="13">
            <NavLink to="/verifiedCompanies" exact>
              <span
                className="icon"
                style={{
                  background: page === "verifiedCompanies" ? color : "",
                }}
              >
                <VerifiedOutlined />
              </span>
          ...
          <Menu.Item key="14">
            <NavLink to="/unVerifiedCompanies" exact>
              <span
                className="icon"
                style={{
                  background: page === "unVerifiedCompanies" ? color : "",
                }}
              >
                <UserSwitchOutlined />
              </span>
          ...
          <Menu.Item key="15">
            <NavLink to="/allInvestors" exact>
              <span
                className="icon"
                style={{
                  background: page === "allInvestors" ? color : "",
                }}
              >
                <ProfileOutlined />
              </span>
          ...
          <Menu.Item key="16">
            <NavLink to="/verifiedInvestors" exact>
              <span
                className="icon"
                style={{
                  background: page === "verifiedInvestors" ? color : "",
                }}
              >
                <SafetyCertificateOutlined />
              </span>
          ...
          <Menu.Item key="17">
            <NavLink to="/unVerifiedInvestors" exact>
              <span
                className="icon"
                style={{
                  background: page === "unVerifiedInvestors" ? color : "",
                }}
              >
                <UserDeleteOutlined />
              </span>
        ...
        {/* {role === "INVESTOR" && (
          <Menu.Item key="15">
            <NavLink to="/totalInvestment" exact>
              <span
                className="icon"
                style={{
                  background: page === "totalInvestment" ? color : "",
                }}
              >
                <TableOutlined />
              </span>
