// // src/pages/BusinessInvestments.js
...
//         const res = await api.get("/investments/getByBusinessId", {
//           headers: { Authorization: `Bearer ${token}` },
//         });

//         // normalize to array even if key is missing or null
//         const rawInvs = res.data["Investments: "];
...
export default function BusinessInvestments() {
  ...
  // Fetch business-specific investments
  useEffect(() => {
    let cancelled = false;
    (async () => {
      try {
        ...
        const raw = Array.isArray(res.data["Investments: "])
