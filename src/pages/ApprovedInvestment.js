// src/pages/ApprovedInvestment.js
...
import { SearchOutlined, DownloadOutlined, ArrowLeftOutlined, DollarOutlined, FundOutlined, RiseOutlined, PercentageOutlined } from "@ant-design/icons";
...
export default function ApprovedInvestment() {
  ...
  return (
    <div style={{ padding: 24 }}>
      ...
      {/* <Row justify="space-between" align="middle">
        <Title level={3}>Approved Investment</Title>
      ...
      >
        <Title level={3}>Approved Handshakes</Title>
